...
class PickupView extends StatelessWidget {
  PickupView({super.key});
  var pickUpCtrl = Get.put(Indexshipmentcontroller());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Obx(() => pickUpCtrl.pendingShipmentView.value.data == null
            ? Center(
                child: Column(
                children: [
            ...
            : pickUpCtrl.pendingListLoading.value
                ? const Center(
                ...
                : ListView.builder(
                    itemCount:
                        pickUpCtrl.pendingShipmentView.value.data?.length,
                    itemBuilder: (_, inx) {
                      var shipmentIndex =
                          pickUpCtrl.pendingShipmentView.value.data?[inx];
