class MailManagementModelOp {
  MailManagementModelOp({
    bool? status,
    String? msg,
    List<Data>? data,
    int? dataa,
  ...
  MailManagementModelOp.fromJson(dynamic json) {
    _status = json['status'];
    _msg = json['msg'];
    if (json['data'] != null) {
      _data = [];
  ...
  int? _dataa;
  int? _total;
  MailManagementModelOp copyWith({
    bool? status,
    String? msg,
    List<Data>? data,
    int? dataa,
...
class Data {
  Data({
    ...
    String? updatedAt,
    int? v,
    List<ShippedDetails>? shippedDetails,
  ...
  Data.fromJson(dynamic json) {
    ...
    if (json['shipped_details'] != null) {
      ...
      json['shipped_details'].forEach((v) {
        _shippedDetails?.add(ShippedDetails.fromJson(v));
      });
    }
  ...
  String? _updatedAt;
  int? _v;
  List<ShippedDetails>? _shippedDetails;
  ...
  int? get v => _v;
  List<ShippedDetails>? get shippedDetails => _shippedDetails;
